            ...
            <ul className="navbar-nav ms-auto mb-2 mb-sm-0">
                ...
                <li className="nav-item my-2 mx-4 d-flex align-items-center">
                    <Link className="nav-link" to="/">
                        <button type="button" className="btn btn-dark text-secondary">Home</button>
                    </Link>
                </li>
                <li className="nav-item my-2 mx-4 d-flex align-items-center">
                    <Link className="nav-link" to="/characters">
                        <button type="button" className="btn btn-dark text-secondary">Characters</button>
                    </Link>
                </li>
                <li className="nav-item my-2 mx-4 d-flex align-items-center">
                    <Link className="nav-link" to="/planets">
                        <button type="button" className="btn btn-dark text-secondary">Planets</button>
                    </Link>
                </li>
                <li className="nav-item my-2 mx-4 d-flex align-items-center">
                    <Link className="nav-link" to="/star-ships">
                        <button type="button" className="btn btn-dark text-secondary">Starships</button>
                    </Link>
                </li>
                <div className="btn-group my-3 mx-4">
